...
class RegisterViewController: BaseViewController {
    ...
    private var capcharConfirm:String?
    ...
    private func validateCode() -> Bool {
        ...
        if count < 5 || confirmTextfield.text != capcharConfirm  {
    ...
    @IBAction func registerPressed(_ sender: Any) {
        ...
        if !validateCode() {
            print("code mobile send not match \(capcharConfirm ?? "")")
            return
        }
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        if textField == linkCodeTextfield {
            ...
            if count < 5 {
                ...
                if confirmTextfield.text != capcharConfirm {
                    confirmTextfield.showErrorIcon()
                } else {
                    confirmTextfield.showCorrectIcon()
                }
